...
// Data imported from shared products data
...
const Products = ({ onAddToCart }: ProductsProps) => {
    ...
    const handleAdd = async (p: Product) => {
        ...
        onAddToCart ? onAddToCart(p) : addItem(p)
        setAddingId(null)
        show("Added to cart")
    }
    return (
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {products.map((product) => (
                        <div key={product.id} className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-smooth h-full flex flex-col">
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <Link href={`/products/${product.id}`} className="text-primary font-semibold text-sm">
                                            View →
                                        </Link>
                                    </div>
                                </div>
